...
class FrontCardsScreen extends StatelessWidget {
  FrontCardsScreen({super.key});
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          /*  _title("Back Side"),
            const SizedBox(height: 12),
            _uploadBox(isFront: false),*/
            const SizedBox(height: 40),
            Obx(() {
              bool enabled =
                  controller.frontCard.value != null;

              return ElevatedButton(
                onPressed: enabled
                    ? () {
                        controller.uploadFrontGrade();
                      }
                    : null,
  ...
  Widget _uploadBox({required bool isFront}) {
    return Obx(() {
      final file = controller.frontCard.value;
      return GestureDetector(
        onTap: () => {
          controller.scanFrontCard()
        },
        child: Container(
          height: 220,
